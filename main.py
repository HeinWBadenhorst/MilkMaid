...
bay1Sol = Pin(14,Pin.OUT)    # GP14 is Output for Bay1 Solenoid
bay2Sol = Pin(15,Pin.OUT)    # GP15 is Output for Bay2 Solenoid
bay3Sol = Pin(16,Pin.OUT)    # GP16 is Output for Bay3 Solenoid
bay4Sol = Pin(17,Pin.OUT)    # GP17 is Output for Bay4 Solenoid
bay5Sol = Pin(18,Pin.OUT)    # GP18 is Output for Bay5 Solenoid
bay6Sol = Pin(19,Pin.OUT)    # GP19 is Output for Bay6 Solenoid
bay7Sol = Pin(20,Pin.OUT)    # GP20 is Output for Bay7 Solenoid
bay8Sol = Pin(21,Pin.OUT)    # GP21 is Output for Bay8 Solenoid
timer_bay1_count = 0
timer_bay2_count = 0
timer_bay3_count = 0
timer_bay4_count = 0
...
def getSpeedColor(vpmIndex):
    ...
    if vpmIndex == 1:
        return (0, 255, 0)  # Generate a green color
    elif vpmIndex == 2:
        return (0, 255, 255)  # Generate a cyan color
    elif vpmIndex == 3:
        return (0, 0, 255)  # Generate a BLUE color
    elif vpmIndex == 4:
        return (255, 0, 255)  # Generate a MAGENTA color
    elif vpmIndex == 5:
        return (255, 0, 0)  # Generate a RED color
    else:
...
def getRestColor(restIndex):
    ...
    if restIndex == 1:
        return (0, 10, 0)  # Generate a green color
    elif restIndex == 2:
        return (0, 0, 10)  # Generate a blue color
    elif restIndex == 3:
        return (10, 0, 0)  # Generate a red color
    else:
        return (0, 0, 0)  # Generate a BLACK color
...
def displayCounts():
    ...
    print("Bay 1 Stats =",timer_bay1_count,"vacuums")
    print("Bay 2 Stats =",timer_bay2_count,"vacuums")
    print("Bay 3 Stats =",timer_bay3_count,"vacuums")
    print("Bay 4 Stats =",timer_bay4_count,"vacuums")
    print("Bay 5 Stats =",timer_bay5_count,"vacuums")
    print("Bay 6 Stats =",timer_bay6_count,"vacuums")
    print("Bay 7 Stats =",timer_bay7_count,"vacuums")
    print("Bay 8 Stats =",timer_bay8_count,"vacuums")
    print("***     ###         ***")
...
while True:
    ...
    if prgm_mode == True:
        ...
        time.sleep_ms(2000)  # Delay for a short period to control the animation speed
        displayCounts()
